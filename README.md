...
A modern, production-ready SaaS starter template for building full-stack applications using Next.js 15, Convex, and Clerk for authentication. Billing and payment features have been removed in this fork.
...
- �� **Webhook Integration** - Automated user sync
...
7. (Optional) Set up Clerk webhooks (in Clerk Dashboard, not Convex):
   - Go to your Clerk dashboard → Webhooks section
   - Create a new endpoint with URL: `${NEXT_PUBLIC_CONVEX_URL}/api/webhook`
   - Enable these events:
   ...
   **Note**: The webhook URL `/api/webhook` is handled by Convex's HTTP router, not Next.js. Svix is used to verify webhook signatures for security.

8. Billing removed in this fork.
...
// Payment attempts tracking removed
```
...
│   │   ├── layout.tsx
│   │   ├── page.tsx
│   │   └── (payment-gated removed)
│   ├── globals.css         # Global styles
│   ├── layout.tsx          # Root layout
│   └── not-found.tsx       # Custom 404 page
├── components/
│   ├── ui/                 # shadcn/ui components
│   ├── (custom-clerk-pricing removed)
│   ├── theme-provider.tsx
│   └── ...
├── convex/                 # Backend functions
│   ├── schema.ts           # Database schema
│   ├── users.ts            # User management
│   ├── (paymentAttempts removed)
...
- ✅ **Clerk + Convex** make it incredibly simple
...
- ✅ **Production ready** - Authentication and database included
...
**Stop rebuilding the same foundation over and over.** Starter.diy eliminates weeks of integration work by providing a complete, production-ready SaaS template with authentication and real-time data working seamlessly out of the box.
