...
## Project Overview
This is a Next.js 15 SaaS starter template with integrated authentication (Clerk) and real-time database (Convex). Billing and payments have been removed in this fork.
...
- `CLERK_WEBHOOK_SECRET` (optional, if you enable Clerk user webhooks)

### Webhook Configuration
Clerk webhooks must be configured to:
- Endpoint: `{your_domain}/api/clerk-users-webhook`
- Events: `user.created`, `user.updated`, `user.deleted` (payment events removed)
